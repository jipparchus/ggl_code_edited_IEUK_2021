...
class VideoPlayer:
    ...
    def play_video(self, video_id):
        ...
        next_video = self._video_library.get_video(video_id).title
        current_video = "No video"

        if current_video != "No video":      #if there is a video playing now
            print("Stopping video: " + current_video)
            print("Playing video: " + next_video)
            current_video = next_video
        elif current_video == "No video":     #if there is no video playing
            print("Playing video: " + next_video)
